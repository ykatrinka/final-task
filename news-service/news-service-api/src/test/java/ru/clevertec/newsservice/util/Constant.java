...
public class Constant {
    ...
    public static final UUID NEWS_UUID_FAIL = UUID.fromString("45f1ab38-8678-4271-a0b2-82f5c4de544c");
    ...
    public static final String SEARCH_TEXT = "News";
    public static final List<String> SEARCHABLE_FIELDS = List.of("title", "text");
